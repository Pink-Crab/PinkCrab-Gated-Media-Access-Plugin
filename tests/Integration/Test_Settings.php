...
class Test_Settings extends WP_UnitTestCase {
	...
	public function set_up(): void {
		...
		$this->page     = new Settings_Page( $this->settings, new \PinkCrab\Gated_Access\Settings\Notification_Fields( $this->settings ), new \PinkCrab\Gated_Access\Settings\Account_Fields( $this->settings ) );
	}
